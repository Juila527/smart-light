...
class WS2812:
    ...
    def __init__(self, spi_bus=1, led_count=1, intensity=0.1):
        """
        Params:
        ...
        * intensity = light intensity (float up to 1)
        ...
        # SPI init
        self.spi = SPI(1,baudrate = 3200000,polarity= 1,phase = 0,bits = 8,endia = 0,sck = Pin(0),mosi = Pin(2),miso = Pin(1))
